...
public class GravityManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Cursor != null)
        {
            ...
            if (primaryDown)
            {
                if (canPlace && hitInfo.transform != null && hitInfo.transform.gameObject.name.Contains("MonoObject") && hitInfo.collider != null && hitInfo.collider.attachedRigidbody != null)
                {
