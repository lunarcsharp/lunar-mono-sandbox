...
public class BoxManager : PlacementHandling
{
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        if (!IsPlane)
        {
            ...
            NetworkManager.RegisterSpawned(IsPlane ? "plane" : "box", Box);
        }
        else
        {
            GameObject Box = GameObject.CreatePrimitive(PrimitiveType.Cube);
            ...
            NetworkManager.RegisterSpawned("plane", Box);
        }
    }
...
public class SphereManager : PlacementHandling
{
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        if (!IsSoftbody && !IsEnemy)
        {
            ...
            NetworkManager.RegisterSpawned("sphere", Ball);
        }
        else if (IsSoftbody && !IsEnemy)
        {
            ...
            NetworkManager.RegisterSpawned("softbody", Ball);
        }
        else if (!IsSoftbody && IsEnemy)
        {
            ...
            NetworkManager.RegisterSpawned("entity", Ball);
        }
    }
}
...
public class BeanManager : PlacementHandling
{
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        if (IsBarrel)
        {
            ...
            NetworkManager.RegisterSpawned("barrel", Bean);
        }
        else if (IsWheel)
        {
            ...
            NetworkManager.RegisterSpawned("wheel", Bean);
        }
        else
        {
            ...
            NetworkManager.RegisterSpawned("bean", Bean);
        }
    }
}
...
public class BathManager : PlacementHandling
{
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        NetworkManager.RegisterSpawned("bath", BathObject);
    }
}
...
public class CrateManager : PlacementHandling
{
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        NetworkManager.RegisterSpawned("crate", CrateObject);
    }
}
...
public class CouchManager : PlacementHandling
{
    ...
    public override void Activated(RaycastHit hitInfo)
    {
        ...
        NetworkManager.RegisterSpawned("couch", CouchObject);
    }
}
