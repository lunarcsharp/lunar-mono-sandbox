...
public class WeaponManager : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (canFire)
            {
                if (Time.time > lastShot + 0.5f)
                {
                    if (holdingWeapon == 0)
                    {
                        ...
                        Physics.Raycast(HeldWeapon.transform.GetChild(0).position, HeldWeapon.transform.GetChild(0).forward, out RaycastHit hit, 1000, player.locomotionEnabledLayers);
                    ...
                    if (holdingWeapon == 5)
                    {
                        ...
                        Physics.Raycast(HeldWeapon.transform.GetChild(0).position, -HeldWeapon.transform.GetChild(0).up, out RaycastHit hit, 1000, player.locomotionEnabledLayers);
                        GameObject hitPoint = Instantiate(HitPointParticle);
                        hitPoint.transform.position = hit.point;
                        hitPoint.transform.forward = hit.normal;
                        hitPoint.transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
                    ...
                    if (holdingWeapon == 6)
                    {
                        ...
                        Physics.Raycast(HeldWeapon.transform.GetChild(6).position, -HeldWeapon.transform.GetChild(6).right, out RaycastHit hit, 1000, player.locomotionEnabledLayers);
                        if (hit.transform != null && hit.transform.name.Contains("MonoObject") && hit.transform.GetComponent<Renderer>() != null)
                        {
                ...
                if (Time.time > lastShot + 0.75f)
                {
                    ...
                    {
                        lastShot = Time.time;
                        player.GetComponent<Rigidbody>().AddForce(-HeldWeapon.transform.GetChild(0).forward * weaponForce * 2200);
                        HeldWeapon.GetComponent<AudioSource>().PlayOneShot(HeldWeapon.GetComponent<AudioSource>().clip);
                        HeldWeapon.transform.GetComponentInChildren<ParticleSystem>().Play();
                        HeldWeapon.GetComponent<SineGunAnimation>().Play();
                ...
                if (Time.time > lastShot + 1.25f)
                {
                    ...
                    if (holdingWeapon == 3)
                    {
                        ...
                        player.GetComponent<Rigidbody>().AddForce(-HeldWeapon.transform.GetChild(0).forward * weaponForce * 4500);
                        Physics.Raycast(HeldWeapon.transform.GetChild(0).position, HeldWeapon.transform.GetChild(0).forward, out RaycastHit hit, 1000, player.locomotionEnabledLayers);
                        GameObject hitPoint = Instantiate(HitPointParticle);
                        hitPoint.transform.position = hit.point;
                        hitPoint.transform.forward = hit.normal;
        ...
        if (!editMode && HeldWeapon != null)
        {
            ...
            if (NetworkManager.Instance != null)
                NetworkManager.Instance.ClearWeapon(Photon.Pun.PhotonNetwork.LocalPlayer.ActorNumber);
        }
    }
    ...
    void WeaponStuff(int index)
    {
        ...
        if (NetworkManager.Instance != null && HeldWeapon != null)
            NetworkManager.Instance.SyncWeapon(Photon.Pun.PhotonNetwork.LocalPlayer.ActorNumber, index, HeldWeapon.transform.position, HeldWeapon.transform.rotation);
    }
}
...
public class HammerManager : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        else if (editMode && holdable != null && Time.time > (lastTime + 0.25f) && _velEstimator != null && _velEstimator.angularVelocity.magnitude > 4f)
        {
...
public class PhysGunManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (editMode)
        {
            ...
            Cursor.GetComponent<Renderer>().material.color = (hitInfo.collider != null && hitInfo.collider.attachedRigidbody != null && hitInfo.transform != null && hitInfo.transform.gameObject.name.Contains("MonoObject")) ? new Color(0f, 1f, 1f, 0.4509804f) : new Color(1f, 0f, 0f, 0.4509804f);
            if (BasePoint == null)
            {
            ...
            if (trigger > 0.6f)
            {
                ...
                if ((hitInfo.collider != null && hitInfo.collider.attachedRigidbody != null && hitInfo.transform != null && hitInfo.transform.gameObject.name.Contains("MonoObject")))
                {
                    if (!shooting)
                    {
            ...
            if (gunIndex == 2)
            {
                ...
                if (melonExplode != null)
                {
                    ...
                    foreach (Transform child in exploded.transform)
                    {
                        ...
                        if (rb != null)
                        {
                            rb.velocity = (child.position - transform.position) * 50f;
                        }
