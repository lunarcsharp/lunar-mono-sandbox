...
namespace MonoSandbox
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            Logger.LogInfo($"[{PluginInfo.Name}] Loading...");
        ...
        private void Start()
        {
            ...
            Invoke(nameof(InitializeMod), 1f);
        }
        ...
        private void InitializeMod()
        {
            ...
            _layerMask = GorillaLocomotion.GTPlayer.Instance != null ? GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers : (LayerMask)(-1);
            _layerMask |= 1 << 8;
            ...
            if (_bundle == null)
            {
                Logger.LogError($"[{PluginInfo.Name}] Failed to load asset bundle!");
                return;
            }
            ...
            ObjectSpawner.RegisterPrefab("Barrel", _bundle.LoadAsset<GameObject>("Barrel"));
            ObjectSpawner.RegisterPrefab("Crate", _bundle.LoadAsset<GameObject>("Crate"));
            ObjectSpawner.RegisterPrefab("Couch", _bundle.LoadAsset<GameObject>("Couch"));
            ObjectSpawner.RegisterPrefab("Bath", _bundle.LoadAsset<GameObject>("Bath"));
            ObjectSpawner.RegisterPrefab("BoneSphere", _bundle.LoadAsset<GameObject>("BoneSphere"));
            ObjectSpawner.RegisterPrefab("Demon", _bundle.LoadAsset<GameObject>("Demon"));
            ObjectSpawner.RegisterPrefab("C4_Weapon", _bundle.LoadAsset<GameObject>("C4_Weapon"));
            ObjectSpawner.RegisterPrefab("Mine_02", _bundle.LoadAsset<GameObject>("Mine_02"));
            ObjectSpawner.RegisterPrefab("Thruster 1", _bundle.LoadAsset<GameObject>("Thruster 1"));
            ObjectSpawner.RegisterPrefab("Balloon", _bundle.LoadAsset<GameObject>("Balloon"));
            ObjectSpawner.RegisterPrefab("Body", _bundle.LoadAsset<GameObject>("Body"));
            ObjectSpawner.RegisterPrefab("GorillaBody", _bundle.LoadAsset<GameObject>("GorillaBody"));
            ObjectSpawner.RegisterPrefab("Pistol", _bundle.LoadAsset<GameObject>("Pistol"));
            ObjectSpawner.RegisterPrefab("Shotgun", _bundle.LoadAsset<GameObject>("Shotgun"));
            ObjectSpawner.RegisterPrefab("Cannon", _bundle.LoadAsset<GameObject>("Cannon"));
            ObjectSpawner.RegisterPrefab("SniperRifle", _bundle.LoadAsset<GameObject>("SniperRifle"));
            ObjectSpawner.RegisterPrefab("LaserGun", _bundle.LoadAsset<GameObject>("LaserGun"));
            ObjectSpawner.RegisterPrefab("Banan", _bundle.LoadAsset<GameObject>("Banan"));
            ObjectSpawner.RegisterPrefab("ToolGun", _bundle.LoadAsset<GameObject>("ToolGun"));
            ObjectSpawner.RegisterPrefab("AssaultRifle", _bundle.LoadAsset<GameObject>("AssaultRifle"));
            ...
            Logger.LogInfo($"[{PluginInfo.Name}] Mod initialized!");
        }
        ...
        public void Update()
        {
            ...
            if (GorillaLocomotion.GTPlayer.Instance != null)
            {
                RefCache.HitExists = Physics.Raycast(
                    ...
                    GorillaLocomotion.GTPlayer.Instance.RightHand.controllerTransform.forward,
                    out RefCache.Hit, 2000, _layerMask);
            }

            #region List

            if (Photon.Pun.PhotonNetwork.InRoom && enabled && _initialized)
            {
